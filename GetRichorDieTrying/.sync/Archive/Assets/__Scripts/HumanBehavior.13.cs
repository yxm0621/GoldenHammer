...
//			Debug.Log ("Started Down");
			//sameDir = true;
			iTween.MoveTo(human, iTween.Hash("x", -1.3, "time", 1.0f, "easetype", iTween.EaseType.linear, "oncomplete", "Move"));
...
//			Debug.Log ("Started Up");
			//sameDir = false;
			iTween.MoveTo(human, iTween.Hash("x", 1.3, "time", 0.5f, "easetype", iTween.EaseType.linear, "oncomplete", "Move"));
