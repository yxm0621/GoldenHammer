...
public class HumanBehavior : MonoBehaviour {
	...
	public void Move(){
		...
		if(startedLeft){
			Debug.Log ("Moving down road");
			iTween.MoveTo(human, iTween.Hash ("z", leftDownPos.z, "time", 2.0f, "easetype", iTween.EaseType.linear));
			
		}
		
		if(startedRight){
			Debug.Log ("Moving down road");
			iTween.MoveTo(human, iTween.Hash ("z", rightDownPos.z, "time", 3.0f, "easetype", iTween.EaseType.linear));
		}
