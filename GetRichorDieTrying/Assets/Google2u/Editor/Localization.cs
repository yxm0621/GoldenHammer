...
namespace Google2u
{
	...
	public sealed class Localization : IGoogle2uDB
	{
		...
		private Localization()
		{
			...
			Rows.Add( new LocalizationRow("ID_MESSAGE_LOGGED_IN_AS", "Logged In As", "Connecté En Tant Que", "Collegato Come", "Angemeldet als", "Conectado como", "تسجيل الدخول ك", "登录为", "としてログイン", "로 로그인", "Logged In Như", "Вы вошли как", "Ingelogd als"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_LOGIN", "Log In", "S'identifier", "Login", "Einloggen", "Iniciar la sesión", "تسجيل الدخول", "登录", "ログイン", "에 로그인", "Đăng Nhập", "Войти", "Log In"));
			Rows.Add( new LocalizationRow("ID_LABEL_LOGOUT", "Log Out", "Se Déconnecter", "Uscire", "Ausloggen", "Finalizar la sesión", "خروج", "注销", "ログアウト", "로그 아웃", "Đăng Xuất", "Выйти", "Uitloggen"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_ENABLE", "Enable", "Permettre", "Enable", "Ermöglichen", "Permitir", "تمكين", "启用", "有効にします", "사용", "Cho phép", "Включить", "In staat stellen"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_HELP", "Help", "Aider", "Aiuto", "Hilfe", "Ayudar", "مساعدة", "帮助", "助けて", "도와주세요", "Giúp", "Помогите", "Help"));
