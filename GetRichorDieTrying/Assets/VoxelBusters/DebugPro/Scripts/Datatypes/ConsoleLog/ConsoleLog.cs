...
#pragma warning restore
		...
		public ConsoleLog (int _logID, int _tagID, string _message, eConsoleLogType _type, UnityEngine.Object _context, int _skipFrames)
		{
		...
		private void CollectStackTraceInfo (StackTrace _stackTrace)
		{
