...
namespace VoxelBusters.NativePlugins
{
	...
	public partial class BillingAndroid : Billing 
	{
		...
		protected override void Initialise (BillingSettings _settings)
		{
			...
			//Call requestForBillingProducts after init. This is required in android as we need details on wht items are consumable.
			RequestForBillingProducts(_settings.Products);
		}
