...
namespace VoxelBusters.NativePlugins
{
	...
	{	
		...
		{
			return string.Format ("CrossPlatformNotification: AlertBody={0} FireDate={1} iOSProperties={2} AndroidProperties={3}",
			                      AlertBody, FireDate, iOSProperties, AndroidProperties);
		}
