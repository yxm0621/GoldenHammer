...
namespace VoxelBusters.NativePlugins
{
	...
	public partial class TwitterAndroid : Twitter 
	{
		...
		protected override void Initialise (TwitterSettings _settings)
		{
			Plugin.Call(NativeInfo.Methods.INITIALIZE,_settings.ConsumerKey, _settings.ConsumerSecret);
		}
		...
		public override void Login (TWTRLoginCompletion _onCompletion)
		{
			...
			if(string.IsNullOrEmpty(NPSettings.Twitter.ConsumerKey) || string.IsNullOrEmpty(NPSettings.Twitter.ConsumerSecret))
				Console.LogError(Constants.kDebugTag, "[Twitter] Please setup Twitter ConsumerKey and ConsumerSecret keys in NPSettings.");
