...
namespace VoxelBusters.Utility
{
	public static class ReflectionExtensions 
	{
		...
		public static FieldInfo[] GetFields (this SerializedObject _serializedObject)
		{
			...
			FieldInfo[] _objectFields		= _serializedObject.targetObject.GetType().GetFields(_bindingAttribute);
		...
		public static FieldInfo[] GetFields (this SerializedProperty _serializableProperty)
		{
			...
			FieldInfo[] _containerObjectFields	= _containerObjectType.GetFields(_bindingAttribute);

			return _containerObjectFields;
		}
